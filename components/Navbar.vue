        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <NuxtLink
                        to="/"
                        class="text-xl font-bold flex items-center lg:ml-2.5 text-gray-700"
                    >
                        <img
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <div
                            class="z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg shadow-gray-300 block hidden"
                            id="dropdown-2"
                            style="
                                position: absolute;
                                inset: 0px auto auto 0px;
                                margin: 0px;
                                transform: translate(613px, 58px);
                            "
