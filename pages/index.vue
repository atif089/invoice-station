<template>
  <div>
    ...
    >
      <Head>
        <Title
          >Invoice Station - Galaxy's first cross planetary invoicing
          system</Title
        >
      ...
      <div class="container">
        <div class="relative -mx-4 flex items-center justify-between py-4">
          <div class="w-60 max-w-full px-4">
            <a
              href="/"
              class="items-cente flex w-full text-xl font-bold text-gray-100 lg:ml-2.5"
              ><img
              ...
              /><span class="header-logo"
                ><span
                  ...
                  >Invoice<span class="text-cyan-300">Station</span></span
                ></span
              ></a
            >
          </div>
          <div class="flex w-full items-center justify-between px-4">
              ...
              >
                <ul class="blcok lg:flex">
                  <li class="group relative">
                    <a
                      href="#home"
                      class="ud-menu-scroll text-dark group-hover:text-primary mx-8 flex py-2 text-base lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"
                    >
                      Home
                    </a>
                  </li>
                  <li class="group relative">
                    <a
                      href="#about"
                      class="ud-menu-scroll text-dark group-hover:text-primary mx-8 flex py-2 text-base lg:mr-0 lg:ml-7 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-12"
                    >
                      About
                    </a>
                  </li>
                  ...
                  <li class="submenu-item group relative">
                    ...
                    >
                      <a
                        href="about.html"
                        class="text-body-color hover:text-primary block rounded py-[10px] px-4 text-sm"
                      >
                        About Page
                      </a>
                      <a
            ...
            <div class="hidden justify-end pr-16 sm:flex lg:pr-0">
              ...
              <NuxtLink
                to="/auth/register"
                class="hover:text-dark signUpBtn rounded-lg bg-white bg-opacity-20 py-3 px-6 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100"
              >
                Sign Up
              </NuxtLink>
            </div>
    ...
    <div
      id="home"
      class="relative bg-cyan-600 pt-[120px] md:pt-[130px] lg:pt-[160px]"
    >
      <div class="container">
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              <h1
                class="mb-8 text-3xl font-bold capitalize leading-snug text-white sm:text-4xl sm:leading-snug md:text-[45px] md:leading-snug"
              >
                Galaxy's first cross planetary invoicing system
              </h1>
              <p
                class="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed"
              >
                The Fastest Payment Solution to Accept and Send Local and
              ...
              <ul class="mb-10 flex flex-wrap items-center justify-center">
                <li>
                  <NuxtLink
                    to="/auth/register"
                    class="text-dark hover:text-primary inline-flex items-center justify-center rounded-lg bg-white py-4 px-6 text-center text-base font-medium transition duration-300 ease-in-out hover:shadow-lg sm:px-10"
                  >
                    Get Started
                  </NuxtLink>
                </li>
                <li>
                  <a
                    href="#features"
                    class="flex cursor-pointer items-center py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:opacity-70 sm:px-10"
                  >
                    Learn More
                    <span class="pl-2">
                      <svg
    ...
    <section id="features" class="pt-20 pb-8 lg:pt-[120px] lg:pb-[70px]">
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mb-12 max-w-[750px] lg:mb-20">
              <span class="text-primary mb-2 block text-lg font-semibold">
                Features
              </span>
              <h2
                class="text-dark mb-4 text-3xl font-bold sm:text-4xl md:text-[42px]"
              >
                Main Features Of InvoiceStation
              </h2>
              <p
                class="text-body-color max-w-[650px] text-lg leading-relaxed sm:text-xl sm:leading-relaxed"
              >
                Create your Rapyd account and start sending payment requests to
                customers today And Accept Digital Payments Instantly
              </p>
            </div>
          </div>
        </div>
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
              <div
                class="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-cyan-600"
              >
                <span
                  class="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-cyan-600 bg-opacity-20 duration-300 group-hover:rotate-45"
                ></span>
                <svg
                  width="35"
                  height="35"
              ...
              <p class="text-body-color mb-8 lg:mb-11">
                Global settlement processing and delivery, with single currency
                settlement
              </p>
              <a
                href="javascript:void(0)"
                class="text-body-color hover:text-primary text-base font-medium"
              >
                Learn More
              </a>
            </div>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12" data-wow-delay=".15s">
              ...
              <h4 class="text-dark mb-3 text-xl font-bold">Cross-Border</h4>
              <p class="text-body-color mb-8 lg:mb-11">
                Multi-Country and Cross-Border Payment Platform
              </p>
              <a
                href="javascript:void(0)"
                class="text-body-color hover:text-primary text-base font-medium"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12" data-wow-delay=".2s">
              ...
              <h4 class="text-dark mb-3 text-xl font-bold">Fraud Protection</h4>
              <p class="text-body-color mb-8 lg:mb-11">
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12" data-wow-delay=".25s">
              ...
              <h4 class="text-dark mb-3 text-xl font-bold">Multi Currency</h4>
              <p class="text-body-color mb-8 lg:mb-11">
                Push funds to each recipients preferred local currency
              </p>
              <a
                href="javascript:void(0)"
                class="text-body-color hover:text-primary text-base font-medium"
    ...
    <section
      id="about"
      class="bg-cyan-600 bg-opacity-5 pt-20 pb-20 lg:pt-[120px] lg:pb-[120px]"
    >
      <div class="container">
          ...
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
              ...
              >
                ...
                >
                  <span
                    class="mb-5 inline-block bg-cyan-600 py-2 px-5 text-sm font-medium text-white"
                  >
                    About Us
                  </span>
                  <h2
                  ...
                  <a
                    href="javascript:void(0)"
                    class="inline-flex items-center justify-center rounded bg-cyan-600 py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-90 hover:shadow-lg"
                  >
                    Learn More
                  </a>
                </div>
                <div class="text-center">
                  <div class="relative z-10 inline-block">
                    <img
                      ...
                      style="filter: hue-rotate(313deg)"
                    />
                  </div>
                </div>
              </div>
      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
              ...
              <p
                class="text-body-color text-lg leading-relaxed sm:text-xl sm:leading-relaxed"
              >
        ...
        <div class="flex flex-wrap items-center justify-center">
          <div class="w-full md:w-1/2 lg:w-1/3">
            <div
              class="border-primary shadow-pricing wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-xl border border-opacity-20 bg-white py-10 px-8 text-center sm:p-12 lg:py-10 lg:px-6 xl:p-12"
              data-wow-delay=".15s
              "
            >
              <span
                class="text-dark mb-2 block text-base font-medium uppercase"
              >
                STARTING FROM
              </span>
              <h2 class="text-primary mb-9 text-[28px] font-semibold">
                $ 19.99/mo
              </h2>

              <div class="mb-10">
                <p
                  class="text-body-color mb-1 text-base font-medium leading-loose"
                >
                  1 User
                </p>
                <p
              ...
              <div class="w-full">
                <a
                  href="javascript:void(0)"
                  class="text-primary hover:border-primary inline-block rounded-full border border-[#D4DEFF] bg-transparent py-4 px-11 text-center text-base font-medium transition duration-300 ease-in-out hover:bg-cyan-600 hover:text-white"
                >
                  Purchase Now
                </a>
              </div>
              <span
                class="absolute left-0 bottom-0 z-[-1] block h-14 w-14 rounded-tr-full bg-cyan-600"
              >
              </span>
            </div>
          </div>
          <div class="w-full md:w-1/2 lg:w-1/3">
            <div
              class="shadow-pricing wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-xl bg-gradient-to-b from-teal-500 to-cyan-500 py-10 px-8 text-center sm:p-12 lg:py-10 lg:px-6 xl:p-12"
              data-wow-delay=".1s
              "
            >
              <span
                class="text-primary mb-5 inline-block rounded-full border border-white bg-white py-2 px-6 text-base font-semibold uppercase"
              >
                POPULAR
              </span>
              <span
              ...
              <div class="w-full">
                <a
                  href="javascript:void(0)"
                  class="text-dark hover:bg-dark hover:border-dark inline-block rounded-full border border-white bg-white py-4 px-11 text-center text-base font-medium transition duration-300 ease-in-out hover:text-white"
                >
                  Purchase Now
                </a>
              </div>
          ...
          <div class="w-full md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <span
                class="bg-secondary absolute right-0 top-0 z-[-1] block h-14 w-14 rounded-bl-full"
              >
              </span>
            </div>
          </div>
    ...
    <!-- ====== Faq Section Start -->
    <section
      class="relative z-20 overflow-hidden bg-cyan-600 bg-opacity-5 pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]"
    >
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 lg:w-1/2">
            <div
              class="single-faq wow fadeInUp mb-8 w-full rounded-lg border border-[#ECF4F7] bg-white p-5 sm:p-8"
              data-wow-delay=".1s
              "
            >
              <button class="faq-btn flex w-full items-center text-left">
                <div
                  class="text-primary mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-cyan-600 bg-opacity-5"
                >
                  <svg
                    width="17"
                    height="10"
      ...
      <div class="container px-4">
        ...
        <div class="flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              class="ud-single-testimonial shadow-testimonial wow fadeInUp mb-12 bg-white p-8"
              data-wow-delay=".1s
              "
            >
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
              ...
              <div class="text-center">
                <h4 class="text-dark mb-2 text-lg font-medium">
                  Adveen Desuza
                </h4>
                ...
                <div class="flex items-center justify-center">
                  <a
                    href="javascript:void(0)"
                    class="hover:text-primary mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6]"
                  >
                    <svg
                      width="10"
                      height="18"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
              ...
              <div class="text-center">
                <h4 class="text-dark mb-2 text-lg font-medium">Jezmin uniya</h4>
                <p class="text-body-color mb-5 text-sm font-medium">
                  Product Designer
                </p>
                <div class="flex items-center justify-center">
    ...
    <section id="contact" class="relative py-20 md:py-[120px]">
      <div
        class="absolute top-0 left-0 z-[-1] h-1/2 w-full bg-[#ECF4F7] lg:h-[45%] xl:h-1/2"
      ></div>
      <div class="container px-4">
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div class="ud-contact-content-wrapper">
              <div class="ud-contact-title mb-12 lg:mb-[150px]">
                <span class="text-dark mb-5 text-base font-semibold">
                  CONTACT US
                </span>
              ...
              <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div class="mb-8 flex w-[330px] max-w-full">
                  <div class="text-primary mr-6 text-[32px]">
                    <svg
                      width="29"
                      height="35"
                      viewBox="0 0 29 35"
          ...
          <div class="w-full px-4 lg:w-5/12 xl:w-4/12">
            <div
              class="shadow-testimonial wow fadeInUp rounded-lg bg-white py-10 px-8 sm:py-12 sm:px-10 md:p-[60px] lg:p-10 lg:py-12 lg:px-10 2xl:p-[60px]"
              data-wow-delay=".2s
              "
            >
              ...
              <form>
                <div class="mb-6">
                  <label for="fullName" class="text-dark block text-xs"
                    >Full Name*</label
                  >
                  <input
                    type="text"
                    ...
                    class="focus:border-primary w-full border-0 border-b border-[#f1f1f1] py-4 focus:outline-none"
                  />
                </div>
                <div class="mb-6">
                  <label for="email" class="text-dark block text-xs"
                    >Email*</label
                  >
                  <input
                    type="email"
                ...
                <div class="mb-6">
                  <label for="phone" class="text-dark block text-xs"
                    >Phone*</label
                  >
                  <input
                    type="text"
                ...
                <div class="mb-6">
                  <label for="message" class="text-dark block text-xs"
                    >Message*</label
                  >
                  <textarea
                    name="message"
                    ...
                    class="focus:border-primary w-full resize-none border-0 border-b border-[#f1f1f1] py-4 focus:outline-none"
                  ></textarea>
                </div>
                <div class="mb-0">
                  <button
                    type="submit"
                    class="hover:bg-dark inline-flex items-center justify-center rounded bg-cyan-600 py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out"
                  >
                    Send Message
                  </button>
                </div>
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="mb-7 text-base text-[#ECF4F7]">
            ...
            <div class="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
                    class="hover:text-primary mb-2 inline-block text-base leading-loose text-[#ECF4F7]"
                  >
                    Home
                  </a>
                </li>
          ...
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 md:w-2/3 lg:w-1/2">
              <div class="my-1">
                ...
                >
                  <a
                    href="javascript:void(0)"
                    class="hover:text-primary px-3 text-base text-[#ECF4F7]"
                  >
                    Privacy policy
                  </a>
                  <a
            ...
            <div class="w-full px-4 md:w-1/3 lg:w-1/2">
              <div class="my-1 flex justify-center md:justify-end">
                <p class="text-base text-[#ECF4F7]">
                  © 2022-2024 Invoice Station
                  <a
    ...
    <a
      href="javascript:void(0)"
      class="hover:bg-dark back-to-top fixed bottom-8 right-8 left-auto z-[999] hidden h-10 w-10 items-center justify-center rounded-md bg-cyan-600 text-white shadow-md transition duration-300 ease-in-out"
    >
      <span
