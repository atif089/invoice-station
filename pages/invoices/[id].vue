    ...
    <div class="grid grid-cols-12 gap-4">
      ...
      >
        <div class="space-y-6 overflow-hidden p-4">
          <div class="sm:flex">
            <div class="mb-5 text-2xl font-bold sm:mb-0 sm:text-3xl">
              Invoice #0472
            </div>
          ...
          <div class="space-y-3 sm:ml-auto sm:w-72 sm:text-right">
            <div class="flex justify-between">
              ...
              <div class="text-base font-medium text-gray-900">$415.00</div>
            </div>
            <div class="flex justify-between">
              <div class="text-sm font-medium uppercase text-gray-500">
                Tax rate
            ...
            <div class="flex justify-between">
              ...
              <div class="text-base font-medium text-gray-900">$64.00</div>
            </div>
            <div class="flex justify-between">
